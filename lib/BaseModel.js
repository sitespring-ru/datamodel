...
class BaseModel extends _BaseClass.default {
   ...
   * */
  __createMagicProps() {
    (0, _lodashEs.forEach)(this.__initialData, (value, attrName) => {
  ...
  resetAttributes(names = []) {
    if (!(0, _lodashEs.isEmpty)(names)) {
      const attrs = (0, _lodashEs.pick)(names, this.__initialData);
      this.setAttributes(attrs);
    } else {
  ...
  addError(field, error) {
    if ((0, _lodashEs.has)(this.errors, field)) {
   ...
   * */
  get hasErrors() {
    return !(0, _lodashEs.isEmpty)(this.errors);
  }
  ...
  get firstErrorMessage() {
    return (0, _lodashEs.get)((0, _lodashEs.values)(this.errors), '[0][0]', null);
  }
